...
namespace ZeroMev.ClassifierService
{
    ...
    public class BlockProcess
    {
        ...
        public async void Run()
        {
            ...
            // TODO change to use MevBlock2.Existing to do this...
            // iterate swaps adding sandwiches and arbs, but not swaps
            // iterate nft/liquidations too
            // iterate swaps adding where there are none existing for the txindex
        ...
        private bool GetMEVBlock(long blockNumber, ref MEVBlock2? mevBlock, ref List<DateTime>? arrivals)
        {
            ...
            if (mevBlock == null || blockNumber != mevBlock.BlockNumber)
            {
                ...
                arrivals = null;
                ZmBlock zmb = ZmBlocks.First<ZmBlock>(x => x.BlockNumber == blockNumber);
                if (zmb == null)
                {
